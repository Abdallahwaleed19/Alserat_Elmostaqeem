    ...
    const initApp = async () => {
      try {
        if (!isWeb) {
          ...
          // Token bumped to v6 to defeat Android 10+ Google Drive Auto-Backup silent restores during testing
          const hasLaunched = localStorage.getItem('zad_mobile_launch_v6');
          const isFirstTime = !hasLaunched;

          if (isFirstTime) {
            localStorage.setItem('zad_mobile_launch_v6', 'true');
          }
